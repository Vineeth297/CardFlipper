...
void main()
{
    ...
    u_xlat2.x = vs_TEXCOORD0.y / vs_TEXCOORD0.w;
    u_xlat2.x = u_xlat2.x + _OffsetY;
#ifdef UNITY_ADRENO_ES3
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %11 %154 %181 
                   ...
                   read_only Texture2DSampled %29 = OpSampledImage %23 %27 
                              ...
                              Uniform f32_4* %141 = OpAccessChain %40 %131 
                                  ...
                                  Input f32* %156 = OpAccessChain vs_TEXCOORD0 %155 
                                         f32 %157 = OpLoad %156 
                                  Input f32* %158 = OpAccessChain vs_TEXCOORD0 %50 
                                         f32 %159 = OpLoad %158 
                                         f32 %160 = OpFDiv %157 %159 
                                Private f32* %161 = OpAccessChain %119 %34 
                                                      OpStore %161 %160 
                                Private f32* %162 = OpAccessChain %119 %34 
                                         f32 %163 = OpLoad %162 
                                Uniform f32* %165 = OpAccessChain %40 %164 
                                         f32 %166 = OpLoad %165 
                                         f32 %167 = OpFAdd %163 %166 
                                Private f32* %168 = OpAccessChain %119 %34 
                                                      OpStore %168 %167 
                                Private f32* %169 = OpAccessChain %119 %34 
                                         f32 %170 = OpLoad %169 
                                         f32 %171 = OpExtInst %1 43 %170 %77 %55 
                                Private f32* %172 = OpAccessChain %119 %34 
                                                      OpStore %172 %171 
                                Private f32* %173 = OpAccessChain %119 %34 
                                         f32 %174 = OpLoad %173 
                                Uniform f32* %176 = OpAccessChain %40 %175 
                                         f32 %177 = OpLoad %176 
                                         f32 %178 = OpFMul %174 %177 
                                Private f32* %179 = OpAccessChain %119 %34 
                                                      OpStore %179 %178 
                                       f32_4 %182 = OpLoad %119 
                                       f32_4 %183 = OpVectorShuffle %182 %182 0 0 0 0 
                                       f32_4 %184 = OpLoad %109 
